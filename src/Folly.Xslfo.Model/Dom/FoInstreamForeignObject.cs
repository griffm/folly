...
/// <summary>
/// Represents an fo:instream-foreign-object element for embedding foreign content (e.g., SVG).
/// </summary>
public sealed class FoInstreamForeignObject : FoElement
{
    /// <inheritdoc/>
    public override string Name => "instream-foreign-object";
    ...
    /// <summary>
    /// Gets the embedded foreign content (e.g., SVG XML element).
    /// </summary>
    public System.Xml.Linq.XElement? ForeignContent { get; init; }
}
