...
/// <summary>
/// Represents the fo:page-number-citation-last element.
/// Used to reference the page number of a page containing the last normal area
/// returned by a formatting object with an id matching the ref-id property.
/// </summary>
public sealed class FoPageNumberCitationLast : FoElement
{
    /// <inheritdoc/>
    public override string Name => "page-number-citation-last";
